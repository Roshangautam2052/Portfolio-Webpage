...
new Typewriter('#typewriter', {
  strings: ['Roshan Gautam', 'Software Developer ', 'Backend Developer',''],
  autoStart: true,
  loop: true,
  cursor: "|"
});
...
//=========Setting up SMTP server for sending email ==================//
function Send(){
    ...
    console.log(body);
    Email.send({
    SecureToken : "39add5a4-00e7-4021-9f2c-ac45be2c8a1f",
    To : 'roshangautam1876@gmail.com',
    From : "roshangautam1876@gmail.com",
    Subject : subject,
    Body : body
        }).then(
        message => {
            if(message=='OK'){
                ...
                swal("Oops!", "Oops! Something went Wrong, Try Again!", "error");
            }
        }
    );
